...
import com.stratos.old.Statement.ExpressionStatement;
    ...
    public Statement execute(Token token) throws Exception {
        ...
        if (conainsMoreThanOneExpresion(token)) {
            ...
            while (!super.isAtEnd()) {
                ...
                if (c.getType() == NodeType.StringValue || c.getType() == NodeType.SignedFloatNode || c.getType() == NodeType.UnSignedFloatNode  || c.getType() == NodeType.SignedNumericNode || c.getType() == NodeType.UnSignedNumericNode  || c.getType() == NodeType.AlphaNumericNode
                        &&
