...
define void @jumbo(i32 %arg0) {
  %people.addr = alloca i32
  store i32 %arg0, i32* %people.addr
  %t0 = getelementptr inbounds [8 x i8], [8 x i8]* @.str5, i64 0, i64 0
  %t1 = call i32 @println(i8* %t0)
  ret void
}
...
define void @main() {
  %t0 = getelementptr inbounds [26 x i8], [26 x i8]* @.str6, i64 0, i64 0
  %t1 = call i32 @println(i8* %t0)
  %t2 = call i32 @hello()
  %t3 = getelementptr inbounds [7 x i8], [7 x i8]* @.str7, i64 0, i64 0
  %t4 = call i32 @printName(i8* %t3)
  %t5 = call i32 @printNumber(i32 42)
  %t6 = getelementptr inbounds [7 x i8], [7 x i8]* @.str7, i64 0, i64 0
  %t7 = call i32 @printNameAndIsMale(i8* %t6, i1 1)
  %me_8 = alloca i32
  %t9 = getelementptr inbounds [7 x i8], [7 x i8]* @.str7, i64 0, i64 0
  %t10 = call i32 @returnAge(i8* %t9)
  store i32 %t10, i32* %me_8
  %t11 = getelementptr inbounds [8 x i8], [8 x i8]* @.str8, i64 0, i64 0
  %t12 = call i32 @println(i8* %t11)
  %t13 = load i32, i32* %me_8
  %t14 = call i32 @println(i32 %t13)
  %h_15 = alloca i32
  %t16 = getelementptr inbounds [7 x i8], [7 x i8]* @.str7, i64 0, i64 0
  %t17 = call i32 @printHelloNameAndReturnHeight(i8* %t16)
  store i32 %t17, i32* %h_15
  %t18 = getelementptr inbounds [11 x i8], [11 x i8]* @.str9, i64 0, i64 0
...
; String Literals
@.str9 = private unnamed_addr constant [11 x i8] c"my height:\00"
@.str8 = private unnamed_addr constant [8 x i8] c"my age:\00"
@.str6 = private unnamed_addr constant [26 x i8] c"--- Function Examples ---\00"
@.str5 = private unnamed_addr constant [8 x i8] c"People:\00"
...
@.str7 = private unnamed_addr constant [7 x i8] c"Arthur\00"
