...
L0:
  ...
  %t13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str4, i32 0, i32 0), i32 %t12)
  br label %L2
...
L3:
  ...
  %t19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str4, i32 0, i32 0), i32 %t18)
  br label %L5

L4:
  %t20 = getelementptr inbounds [6 x i8], [6 x i8]* @.str5, i64 0, i64 0
  %t22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str_specifier, i32 0, i32 0), i8* %t20)
  %t23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str4, i32 0, i32 0), i32 %t22)
  br label %L5
...
L7:
  ...
  %t30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str4, i32 0, i32 0), i32 %t29)
  br label %L6

L8:
  %userType_31 = alloca i32
  %t32 = getelementptr inbounds [6 x i8], [6 x i8]* @.str7, i64 0, i64 0
...
; String Literals
@.str7 = private unnamed_addr constant [6 x i8] c"admin\00"
@.str6 = private unnamed_addr constant [3 x i8] c"%d\00"
@.str5 = private unnamed_addr constant [6 x i8] c"Child\00"
@.str3 = private unnamed_addr constant [3 x i8] c"%s\00"
@.str1 = private unnamed_addr constant [6 x i8] c"Minor\00"
@.str4 = private unnamed_addr constant [6 x i8] c"%d\0A\00"
