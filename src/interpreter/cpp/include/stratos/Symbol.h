...
struct Symbol {
    ...
    // Helper constructors
    static Symbol Variable(std::string name, std::string type, bool isMutable, bool isPublic = false) {
        Symbol s;
        s.name = name;
    ...
    static Symbol Function(std::string name, std::vector<std::string> params, std::string ret, bool isPublic = false) {
        Symbol s;
        s.name = name;
