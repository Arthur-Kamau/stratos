...
public class StratosSdkVersion {
  /**
   * The minimum version we suggest people use.
   */
  private static final StratosSdkVersion MIN_SUPPORTED_SDK = new StratosSdkVersion("0.0.12");
   ...
   */
  private static final StratosSdkVersion MIN_SAFE_TRACK_WIDGET_CREATION_SDK = new StratosSdkVersion("0.10.2");

  /**
   * The version that supports --dart-define in the run command.
   */
  private static final StratosSdkVersion MIN_DART_DEFINE_SDK = new StratosSdkVersion("1.12.0");

  /**
   * The version of the stable channel that supports --androidx in the create command.
   */
  private static final StratosSdkVersion MIN_PUB_OUTDATED_SDK = new StratosSdkVersion("1.16.4");

  /**
   * The version that supports --platform in flutter create.
   */
  private static final StratosSdkVersion MIN_CREATE_PLATFORMS_SDK = new StratosSdkVersion("1.20.0");
  ...
  @VisibleForTesting
  public StratosSdkVersion(@Nullable String versionString) {
    version = versionString == null ? null : Version.parseVersion(versionString);
    versionText = versionString;
  }

  @NotNull
  public static StratosSdkVersion readFromSdk(@NotNull VirtualFile sdkHome) {
    return readFromFile(sdkHome.findChild("version"));
  }

  @NotNull
  private static StratosSdkVersion readFromFile(@Nullable VirtualFile file) {
    if (file == null) {
      return new StratosSdkVersion(null);
    }
    ...
    return new StratosSdkVersion(versionString);
  }
