 ...
 */
public class StratosExternalAnnotator extends ExternalAnnotator<PsiFile, List<StratosExternalAnnotator.Issue>> {
	...
	public List<Issue> doAnnotate(final PsiFile file) {
		Collection<? extends PsiElement> funcNameNodes =
			XPath.findAll(StratosLanguage.INSTANCE, file, "/script/function/ID");
		Collection<? extends PsiElement> funcCallNameNodes =
			XPath.findAll(StratosLanguage.INSTANCE, file, "//call_expr/ID");
