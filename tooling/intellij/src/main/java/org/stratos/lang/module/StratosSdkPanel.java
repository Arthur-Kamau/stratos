...
public class StratosSdkPanel extends JPanel {
  ...
  private void createUIComponents() {
    myDownloadLink = new ActionLink("Download and Install Stratos SDK", new AnAction() {
      @Override
        ...
        pathChooser.choose(VfsUtil.getUserHomeDir(), new FileChooser.FileChooserConsumer() {
          ...
          public void consume(List<VirtualFile> virtualFiles) {
            if (virtualFiles.size() == 1) {
              ...
              FileDownloader downloader = fileService.createDownloader(Arrays.asList(fileDescription), null, StratosSdkPanel.this, "Stratos.zip");
