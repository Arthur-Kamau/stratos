...
import org.stratos.lang.utils.SystemUtils;
...
//            FlutterInitializer.sendAnalyticsAction(ANALYTICS_KEY);
            BrowserUtil.browse("https://github.com/Arthur-Kamau/stratos");
        }
...
//                FlutterInitializer.sendAnalyticsAction(ANALYTICS_KEY);
        ...
        private class FlutterPrecacheCommand extends InstallCommand {
            ...
            @Override
            GeneralCommandLine getCommandLine() {
                final String flutterTool = FileUtil.toSystemDependentName(mySdkDir + "/bin/" + StratosSdkUtil.flutterScriptName());
                return new GeneralCommandLine().withParentEnvironmentType(
