 ...
 */
public class StratosSdkManager {
  private final EventDispatcher<Listener> myListenerDispatcher = EventDispatcher.create(Listener.class);
  private boolean isStratosConfigured;
  private final @NotNull Project myProject;

  @NotNull
  public static StratosSdkManager getInstance(@NotNull Project project) {
    return ServiceManager.getService(project, StratosSdkManager.class);
  }

  private StratosSdkManager(@NotNull Project project) {
    myProject = project;
