...
import org.stratos.lang.StratosParserDefinition;
...
public class TestXPath extends ParsingTestCase {
	public TestXPath() {
		super("", "Sample", new StratosParserDefinition());
	}
	...
	public void testFuncNames() throws Exception {
		String code = loadFile("test/org/antlr/jetbrains/adaptor/test/test.st");
		String output =
			"f\n"+
			"g\n"+
			"h";
	...
	public void testAllVarDefIDsInScopes() throws Exception {
		String code = loadFile("test/org/antlr/jetbrains/adaptor/test/bubblesort.st");
		String output =
			"x\n"+
			"i\n"+
			"j\n"+
	...
	public void testWildcardUnderFuncThenJustTokens() throws Exception {
		...
		Collection<? extends PsiElement> nodes = XPath.findAll(StratosLanguage.INSTANCE, myFile, xpath);
	...
	protected void checkXPathResults(String code, String xpath, String allNodesText) throws IOException {
		checkXPathResults(StratosLanguage.INSTANCE, code, xpath, allNodesText);
	}
