...
//public class StratosFileElementType {
//}
//
...
public class StratosFileElementType extends ILightStubFileElementType<PsiJavaFileStub> {
    public static final int STUB_VERSION = 50;

    public StratosFileElementType() {
        super("stratos.FILE", StratosLanguage.INSTANCE);
    }
