...
public class StratosTypePackageImpl extends ASTWrapperPsiElement implements StratosTypePackage {

  public StratosTypePackageImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StratosVisitor visitor) {
    visitor.visitTypePackage(this);
  }
