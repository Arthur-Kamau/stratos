...
public class StratosTypeWrapperImpl extends ASTWrapperPsiElement implements StratosTypeWrapper {

  public StratosTypeWrapperImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StratosVisitor visitor) {
    visitor.visitTypeWrapper(this);
  }
