...
import lang.stratos.util.StratosFileBrowser;
...
*/
public class StratosRunConfigurationSettingsEditor extends SettingsEditor<ApplicationConfiguration> implements PanelWithAnchor {
  ...
  public StratosRunConfigurationSettingsEditor(final Project project) {
    ...
    new StratosFileBrowser(myProject, myModuleSelector).setField(getMainClassField());
