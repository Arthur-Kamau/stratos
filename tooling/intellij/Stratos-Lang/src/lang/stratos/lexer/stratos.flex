...
<YYINITIAL> {
  ...
  "package"          { return PACKAGE; }  // This indicates that the `returns` keyword is encountered.
  ...
  "mut"          { return MUTABLE; }  // This indicates that the `returns` keyword is encountered.
  ...
  "override"              { return OVERIDE; }      // This indicates that the `int` keyword is encountered.
  "import"              { return IMPORT; }      // This indicates that the `int` keyword is encountered.
  "struct"              { return STRUCT; }      // This indicates that the `int` keyword is encountered.
  "enum"              { return ENUM; }      // This indicates that the `int` keyword is encountered.
  "implement"              { return IMPLIMENTS; }      // This indicates that the `int` keyword is encountered.
  "extends"              { return EXTENDS; }      // This indicates that the `int` keyword is encountered.
