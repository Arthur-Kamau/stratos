...
public class StratosFileBrowser extends BrowseModuleValueActionListener {
  private final ConfigurationModuleSelector myModuleSelector;

  public StratosFileBrowser(final Project project, ConfigurationModuleSelector moduleSelector) {
    super(project);
