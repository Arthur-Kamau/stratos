...
public class StratosVariableDeclarationImpl extends ASTWrapperPsiElement implements StratosVariableDeclaration {

  public StratosVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
