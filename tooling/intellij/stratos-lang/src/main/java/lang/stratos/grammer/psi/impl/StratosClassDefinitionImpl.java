...
public class StratosClassDefinitionImpl extends ASTWrapperPsiElement implements StratosClassDefinition {

  public StratosClassDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
