...
public class NewStratosFileAction extends CreateFromTemplateAction {
    ...
    public NewStratosFileAction() {
        super(StratosBundle.messagePointer("stratos.file"), StratosBundle.messagePointer("new.stratos.file.title"), StratosIcons.StratosFileIcon);
    }
...
protected PsiFile createFile(String name, String templateName, PsiDirectory dir) {
    ...
    protected void buildDialog(@NotNull Project project, @NotNull PsiDirectory directory, CreateFileFromTemplateDialog.@NotNull Builder builder) {
        ...
        builder.addKind(StratosBundle.message("stratos.file"), StratosIcons.StratosFileIcon, "Stratos File");
        ...
        for (FileTemplate fileTemplate : RsFileTemplateUtil.getApplicableTemplates()) {
            ...
            final Icon icon = StratosIcons.StratosFileIcon;
