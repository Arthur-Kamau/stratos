...
//        import com.jetbrains.lang.dart.lexer.StratosDocLexer;
...
public interface StratosTokenSets {
    ...
    // StratosDocLexer splits MULTI_LINE_DOC_COMMENT in tokens
...
//            new DartParser().parseLight(STRATOS_FILE, builder);
//            return builder.getTreeBuilt().getFirstChildNode();
//        }
//
//        @Override
...
//            boolean result = StratosParser.dartUnit(builder, 0);
