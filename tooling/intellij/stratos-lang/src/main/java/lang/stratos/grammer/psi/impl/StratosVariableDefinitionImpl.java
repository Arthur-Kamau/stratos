...
public class StratosVariableDefinitionImpl extends ASTWrapperPsiElement implements StratosVariableDefinition {
  ...
  @Override
  @Nullable
  public StratosVariableDeclarationWithTypes getVariableDeclarationWithTypes() {
    return findChildByClass(StratosVariableDeclarationWithTypes.class);
  }

  @Override
  @Nullable
  public StratosVariableDeclarationWithoutTypes getVariableDeclarationWithoutTypes() {
    return findChildByClass(StratosVariableDeclarationWithoutTypes.class);
  }
