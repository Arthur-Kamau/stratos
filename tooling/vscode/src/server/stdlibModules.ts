...
export const stdlibModules = {
    ...
    'maps': [
        { name: 'create', type: 'function', params: '', returnType: 'Map', doc: 'Create an empty map' },
        { name: 'set', type: 'function', params: 'key: string, value: string', returnType: 'Map', doc: 'Set a key-value pair (returns new map)' },
        { name: 'get', type: 'function', params: 'key: string', returnType: 'string', doc: 'Get value by key (returns empty string if not found)' },
        { name: 'has', type: 'function', params: 'key: string', returnType: 'bool', doc: 'Check if key exists' },
        { name: 'remove', type: 'function', params: 'key: string', returnType: 'Map', doc: 'Remove a key-value pair (returns new map)' },
        { name: 'size', type: 'function', params: '', returnType: 'int', doc: 'Get number of entries' },
        { name: 'keys', type: 'function', params: '', returnType: 'Array<string>', doc: 'Get all keys as array' },
        { name: 'values', type: 'function', params: '', returnType: 'Array<string>', doc: 'Get all values as array' },
        { name: 'clear', type: 'function', params: '', returnType: 'Map', doc: 'Remove all entries (returns empty map)' },
        { name: 'isEmpty', type: 'function', params: '', returnType: 'bool', doc: 'Check if map is empty' },
        { name: 'first', type: 'function', params: '', returnType: 'string', doc: 'Get first key' },
        { name: 'last', type: 'function', params: '', returnType: 'string', doc: 'Get last key' },
        { name: 'firstValue', type: 'function', params: '', returnType: 'string', doc: 'Get first value' },
        { name: 'lastValue', type: 'function', params: '', returnType: 'string', doc: 'Get last value' },
        { name: 'merge', type: 'function', params: 'other: Map', returnType: 'Map', doc: 'Merge with another map' },
        { name: 'entries', type: 'function', params: '', returnType: 'Array<string>', doc: 'Get entries as "key:value" array' },
        { name: 'containsValue', type: 'function', params: 'value: string', returnType: 'bool', doc: 'Check if value exists' },
        { name: 'fromEntries', type: 'function', params: 'entries: Array<string>', returnType: 'Map', doc: 'Create map from "key:value" array' },
    ],
};